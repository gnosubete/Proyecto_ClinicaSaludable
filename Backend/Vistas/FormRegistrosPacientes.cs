...
namespace Clinica_de_salud.Vistas
{
    public partial class FormRegistrosPacientes : Form
    {
        ...
        private void btnregistrar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (var conn = Conexion.ObtenerConexion())
                {
                    ...
                    MessageBox.Show("Registro completado con éxito", "Éxito", MessageBoxButtons.OK);
                    LimpiarCampos();
                    this.Close();
                }
            }
            ...
            {
                MessageBox.Show($"Ocurrió un error con la base de datos: {ex.Message}", "Error", MessageBoxButtons.OK);
            }
        }
        ...
        private void btnRegistro_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("La solicitud de registro se ha cancelado exitosamente", "validacion", MessageBoxButtons.OK);
            this.Close();
        }
    }
}
